...
<br>
  ...
  <img class="image" src="<?php echo  htmlspecialchars($_SESSION['dataalt']['file_url']);?>"/>
      ...
      <br>
      <label>Prénom :</label>
      <?php echo $_SESSION['dataalt']['Prenom']; ?>
      <br>
      <br>
      <label>Nom :</label>
      <?php echo $_SESSION['dataalt']['Nom']; ?>
      <br>
      <br>
      <label>Email personnel :</label>
      <?php echo $_SESSION['dataalt']['Email_perso']; ?>
      <br>
      <br>
      <label>Email professionnel :</label>
      <?php echo $_SESSION['dataalt']['Email_pro']; ?>
      <br>
      <br>
      <label>Numéro de téléphone personnel :</label>
      <?php echo $_SESSION['dataalt']['Tel_perso']; ?>
      <br>
      <br>
      <label>Numéro de téléphone professionnel :</label>
      <?php echo $_SESSION['dataalt']['Tel_pro']; ?>
      <br>
      <br>
