...
<form action="modification_gestion_superviseur.php" method="post">
<?php
...
echo '<table class="table table-bordered">';
    ...
    echo '<td><input size="12" name="Nom'.$data['ID_superviseur'].'" value="'.$data['Nom'].'"><br></td>';
    echo '<td><input size="12" name="Prenom'.$data['ID_superviseur'].'" value="'.$data['Prenom'].'"><br></td>';
    echo '<td><input size="16" name="Email_perso'.$data['ID_superviseur'].'" value="'.$data['Email_perso'].'"><br></td>';
    echo '<td><input size="16" name="Email_pro'.$data['ID_superviseur'].'" value="'.$data['Email_pro'].'"><br></td>';
    echo '<td><input size="10" name="Tel_perso'.$data['ID_superviseur'].'" value="'.$data['Tel_perso'].'"><br></td>';
    echo '<td><input size="10" name="Tel_pro'.$data['ID_superviseur'].'" value="'.$data['Tel_pro'].'"><br></td>';
    ...
    echo '<td><div class="form-group">
      <select class="form-control" name="Entreprise'.$data['ID_superviseur'].'">';
    while($data5 = $requete5->fetch()){
        echo '<option value="'.$data5['Entreprise'].'" name="Entreprise'.$data['ID_superviseur'].'"';
...
echo '</select> </div><br></td>';
    ...
    $requete4 = $base4->prepare('SELECT count(*) FROM alternant WHERE ID_superviseur=? AND ID2_superviseur=?');
    ...
    echo '<td class="align-middle text-center"><input type="checkbox" name="Supprimer'.$data['ID_superviseur'].'" value="supprimer"></td>';
