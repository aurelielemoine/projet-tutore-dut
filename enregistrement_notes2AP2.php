...
if(isset($_POST['enregistrer'])){
  ...
  $notes4 = array('cc15' => $_POST['cc15'], 'cc152' => $_POST['cc152'], 'ct16' => $_POST['ct16'], 'cc16' => $_POST['cc16'], 'cc17' => $_POST['cc17'], 'cc18' => $_POST['cc18'], 'cc19' => $_POST['cc19'], 'cc20' => $_POST['cc20']);

  $notes5 = array('ct21' => $_POST['ct21'], 'ct212' => $_POST['ct212'], 'ct22' => $_POST['ct22'],  'ct23' => $_POST['ct23'],  'tp23' => $_POST['tp23'], 'cp24' => $_POST['cp24']);

  $notes6 = array('tp24' => $_POST['tp24'], 'cp25' => $_POST['cp25'], 'tp25' => $_POST['tp25'], 'tp26' => $_POST['tp26'], 'cp27' => $_POST['cp27'], 'tp27' => $_POST['tp27'], 'ct28' => $_POST['ct28']);

  $notes7 = array('tp28' => $_POST['tp28'], 'cp29' => $_POST['cp29'], 'cp292' => $_POST['cp292'], 'tp29' => $_POST['tp29']);
...
header('Location:Page_de_notes_2eme_annee_P2.php');
